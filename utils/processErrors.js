...
class ExceededProcessesLimitError extends Error {
  constructor(message) {
    super(message);
    this.name = "ExceededProcessesLimitError";
  }
}
...
class ProcessExecutedError extends Error {
  constructor(message) {
    super(message);
    this.name = "ProcessExecutedError";
  }
...
class ProcessNotCompletedError extends Error {
  constructor(message) {
    super(message);
    this.name = "ProcessNotCompletedError";
  }
}

class ProcessNotRunningError extends Error {
  constructor(message) {
    super(message);
